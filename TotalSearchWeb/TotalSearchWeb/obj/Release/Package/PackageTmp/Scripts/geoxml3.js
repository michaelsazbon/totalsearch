...
geoXML3.parser = function (options) {
    ...
    var createMarker = function (placemark, doc) {
        ...
        //marker.set("id", placemark.name);
        appartementsmarkers.push(marker);
        if (!!doc) {
...
geoXML3.fetchXML = function (url, callback) {
    ...
    if (!xhrFetcher.fetcher) {
        ...
        xhrFetcher.fetcher.open('POST', baseUrl, true);
        xhrFetcher.fetcher.onreadystatechange = function () {
            if (xhrFetcher.fetcher.readyState === 4) {
                ...
                if (xhrFetcher.fetcher.status >= 400) {
                    ...
                    //alert(gup("api_key", url));

//                    var key = "2e35f242a46d67eeb74aabc37d5e5d05";
//                    var iv = "2547851236965624";
...
//                    //var encrypted = { key: key, iv: iv, ciphertext: xhrFetcher.fetcher.responseText };
//                    //var plaintextPart1 = aesDecryptor.process(ciphertextPart1);
//                    //var plaintextPart2 = aesDecryptor.finalize();

//                    //alert(plaintextPart1);
//                    //alert(plaintextPart2);

//                    // Decode the base64 data so we can separate iv and crypt text.
//                    //alert(xhrFetcher.fetcher.responseText);
//                    //alert(CryptoJS.enc.Base64.parse(xhrFetcher.fetcher.responseText));
//                    //                    var rawData = atob(xhrFetcher.fetcher.responseText);
//                    //                    alert(rawData);
...
//                    //                    alert(CryptoJS.enc.Hex.parse(key));
//                    //                    alert(CryptoJS.enc.Latin1.parse(crypttext));
//                    //                    alert(CryptoJS.enc.Latin1.parse(iv));

//                    // Decode the base64 data so we can separate iv and crypt text.
//                    //var rawData = atob(xhrFetcher.fetcher.responseText);
//                    //var iv = btoa(rawData.substring(0, 16));
//                    //alert(CryptoJS.enc.Base64.parse(iv));
//                    //var crypttext = btoa(rawData.substring(16));

//                    alert(CryptoJS.enc.Base64.parse(xhrFetcher.fetcher.responseText));

//                    var encrypted = CryptoJS.AES.encrypt(
//                    "totot roorg rogrogro greog gor g",
//                     key,
//                     { keySize: 256, iv: iv, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7 }
//                    );
...
//                    //encrypted,
//                      xhrFetcher.fetcher.responseText,
//                      key,
//                      { iv: iv, keySize: 256, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7 }
//                    );
...
//                    alert(hex2a(plaintextArray.toString()));
        ...
        xhrFetcher.fetcher.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhrFetcher.fetcher.send(Params);
    }
};
